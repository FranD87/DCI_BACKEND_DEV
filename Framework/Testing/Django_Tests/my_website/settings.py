...
SECRET_KEY = 'django-insecure-8w7b(+ss9$6*w6$k*w6ux=jg^_3@%w42+7*pitvztv$3jc^7&i'
...
LOGGING: dict = {
    ...
    "formatters": {
        ...
        "test_print_display_3": {
            "format": " %(levelname)s %(asctime)s %(message)s " #Can be sorted in any order
        },
    },
    "handlers": {
        "console": {
        ...
        "files": {
            ...
            "formatter": "test_print_display_3",
        },
    },
    "root": {
